...
class Event(object):
    ...
    def __repr__(self):
        return "{}({},{},{},{})".format(
            self.pred, self.dep, self.a0, self.a1, self.a2
        )
    ...
    def from_string(cls, line):
        ...
        if res is None:
            print(line)
        return cls(
            res["pred"], res["dep"], res["arg0"], res["arg1"], res["arg2"]
        )
    ...
    @staticmethod
    def predicategr_format(
        pred, dep, a0, a1, a2, protagonist_str="_PROTAGONIST_"
    ):
        if dep == "nsubj":
    ...
    def to_predicategr_format(self):
        return self.predicategr_format(
            self.pred, self.dep, self.a0, self.a1, self.a2
        )
