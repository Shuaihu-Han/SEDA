...
animate_words_fpath = os.path.join(
    module_base, "animacy_data/animate.unigrams.txt"
)
inanimate_words_fpath = os.path.join(
    module_base, "animacy_data/inanimate.unigrams.txt"
)
animate_words = None
