...
class NegativeSampler:
    ...
    def sampling(self, x):
        ...
        chunks = (
            torch.chunk(idxs, 3) if self.sample_rel else torch.chunk(idxs, 2)
        )
        ...
        x_neg[
            chunks[0], 1 : 1 + 1 + self.arg0_max_len + self.arg1_max_len
        ] = neg_e[chunks[0]]
        ...
        neg_e = neg_e[torch.randperm(x.shape[0])]
        x_neg[
            chunks[1], 1 + 1 + self.arg0_max_len + self.arg1_max_len :
        ] = neg_e[chunks[1]]
